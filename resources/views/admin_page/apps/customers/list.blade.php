									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion">
												...
												<div class="menu-item">
													<!--begin:Menu link-->
													<a class="menu-link active" href="customer">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">Customer Listing</span>
												...
												<tbody class="fw-semibold text-gray-600">
													@foreach ($mahasiswa as $data)		
														<tr>
															...
															<td>
																<a href="#" class="text-gray-800 text-hover-primary mb-1">{{ $data->nim }}</a>
															</td>
															<td>
																<a href="#" class="text-gray-600 text-hover-primary mb-1">{{ $data->nama }}</a>
															</td>
															<td>{{ $data->prodi }}</td>
															<td>{{ $data->alamat }}</td>
									...
									<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
										<div class="modal-dialog modal-dialog-centered mw-650px">
											<div class="modal-content">
												<form class="form" action="{{ route('customer.store') }}" method="POST" id="kt_modal_add_customer_form" data-kt-redirect="customer">
													@csrf
													...
													<div class="modal-body py-10 px-lg-17">
														<div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
															<div class="fv-row mb-7">
																<label class="fs-6 fw-semibold mb-2">NIM</label>
																<input type="text" class="form-control form-control-solid" placeholder="" name="nim" value="" />
															</div>
															<div class="fv-row mb-7">
															...
															<div class="fv-row mb-7">
																<label class="fs-6 fw-semibold mb-2">Prodi</label>
																<input type="text" class="form-control form-control-solid" placeholder="" name="prodi" />
															</div>
															<div class="fv-row mb-7">
																<label class="fs-6 fw-semibold mb-2">No Telepon</label>
																<input type="phone" class="form-control form-control-solid" placeholder="" name="noTelp" />
															</div>
															<div class="fv-row mb-7">
															...
															<div class="fv-row mb-7">
																...
																<input type="date" class="form-control form-control-solid" placeholder="" name="tgl_lahir" />
															</div>
														</div>
													</div>
