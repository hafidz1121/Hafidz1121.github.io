...
<script src="{{asset('assets_admin')}}/js/custom/utilities/modals/upgrade-plan.js"></script>
<script src="{{asset('assets_admin')}}/js/custom/utilities/modals/create-account.js"></script>
<script src="{{asset('assets_admin')}}/js/custom/utilities/modals/create-app.js"></script>
<script src="{{asset('assets_admin')}}/js/custom/utilities/modals/users-search.js"></script>