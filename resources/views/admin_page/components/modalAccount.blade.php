                                ...
                                <div class="d-flex flex-column mb-7 fv-row">
                                    ...
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                                            <img src="{{asset('assets_admin')}}/media/svg/card-logos/visa.svg" alt="" class="h-25px" />
                                            <img src="{{asset('assets_admin')}}/media/svg/card-logos/mastercard.svg" alt="" class="h-25px" />
                                            <img src="{{asset('assets_admin')}}/media/svg/card-logos/american-express.svg" alt="" class="h-25px" />
                                        </div>
                                        <!--end::Card logos-->
                                    </div>
                                    <!--end::Input wrapper-->
                        ...
                        <div data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="pb-8 pb-lg-10">
                                    ...
                                    <a href="&lt;br /&gt;&lt;b&gt;Warning&lt;/b&gt;: foreach() argument must be of type array|object, null given in &lt;b&gt;/Users/shuhratsaipov/www/keenthemes/products/core/html/dist/libs/Util.php&lt;/b&gt; on line &lt;b&gt;168&lt;/b&gt;&lt;br /&gt;&lt;br /&gt;&lt;b&gt;Warning&lt;/b&gt;: foreach() argument must be of type array|object, null given in &lt;b&gt;/Users/shuhratsaipov/www/keenthemes/products/core/html/dist/libs/Util.php&lt;/b&gt; on line &lt;b&gt;168&lt;/b&gt;&lt;br /&gt;{{asset('assets_admin')}}/.html" class="link-primary fw-bold">Sign In</a>.</div>
                                    <!--end::Notice-->
                                </div>
                                <!--end::Heading-->
                                <!--begin::Body-->
                                    ...
                                    <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed p-6">
                                        ...
                                        <div class="d-flex flex-stack flex-grow-1">
                                            ...
                                            <div class="fw-semibold">
                                                ...
                                                <a href="{{asset('assets_admin')}}/utilities/wizards/vertical.html" class="fw-bold">Create Team Platform</a></div>
                                            </div>
                                            <!--end::Content-->
                                        </div>
                                        <!--end::Wrapper-->
